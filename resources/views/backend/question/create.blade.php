@extends('backend.layouts.master')
	...
	<div class="module">
            ...
            <div class="control-group">
				...
				<div class="controls">
					<input type="text" name="question" class="span8 @error('name') border-red @enderror" placeholder="name of a Question" value="{{old('questioin')}}" >
				</div>
			     @error('question')
			    <span class="alert-danger" role="alert">
			        <strong>{{ $message }}</strong>
			...
			@enderror
			 ...
			 <div class="control-group">
				...
				<div class="controls">
					...
					<input type="radio" name="correct_answer" class="m-lg-2" value="{{$i}}">
                        <span>Answser</span>
					@endfor
				</div>
			     @error('question')
