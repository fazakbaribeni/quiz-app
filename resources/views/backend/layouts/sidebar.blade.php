                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="{{route('quiz.index')}}"><i class="menu-icon icon-dashboard"></i>Dashboard
                                </a></li>
                            ...
                            <!--/.widget-nav-->
                              <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="{{route('exam.user')}}"><i class="menu-icon icon-inbox"></i>View User Exam <b class="label green pull-right">
                                    </b> </a></li>
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{route('logout')}}"
                                       ...
                                       <i class="icon-inbox"></i>{{__('Logout')}}</a>
