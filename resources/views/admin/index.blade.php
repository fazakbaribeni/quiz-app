...
<script src="{{asset('edmin/code/bootstrap/scripts/flot/jquery.flot.js')}}" type="text/javascript"></script>
<script src="{{asset('edmin/code/bootstrap/scripts/scripts/flot/jquery.flot.resize.js')}}" type="text/javascript"></script>
<script src="{{asset('edmin/code/bootstrap/scripts/scripts/datatables/jquery.dataTables.js')}}" type="text/javascript"></script>
<script src="{{asset('edmin/code/bootstrap/scripts/scripts/common.js" type="text/javascript')}}"></script>
